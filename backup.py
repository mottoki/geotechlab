        ...
        if len(x) > 0:
            if fitmethod == fit_selection[0]:
                ...
                if cimethod == ciselection[0]:
                    dbs, bs_a, bs_b, dlq, lq_a, lq_b, duq, uq_a, uq_b, lq, uq = scipy_models(data, a_intercept, ci, fitmethod, fit_selection)
                else:
                    dbs, bs_a, bs_b, dlq, lq_a, lq_b, duq, uq_a, uq_b, lq, uq = quantile_models(data, a_intercept, ci, fitmethod, fit_selection)
